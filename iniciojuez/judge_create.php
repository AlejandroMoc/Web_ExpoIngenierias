...
<body>
	...
	<form class="divfix" action="judge_create.php" method="post" onsubmit="return verifyPassword()">
		<table width="100%">
			...
			<tr>
				<td>
					1. Escribe una letra X mayuscula seguida de tu día y mes de nacimiento
				</td>
			</tr>

			<tr>
				<td>
					2. Por ultimo ingresa el día y el mes de hoy
				</td>
			</tr>

			<tr>
				<td>
					<p class="create_paragraph"><strong> Tu matrícula deberia verse algo así: X09030205</strong>
				</td>
			</tr>
