...
<body>
	...
	<form class="divfix" action="prof_create.php" method="post" onsubmit="return verifyPassword()">
		<table width="100%">
			<tr>
				<td>
			...
			<tr>
				<td class="botonborde2">
					<button class="botonfinal2"><strong><a href="index.php" class="alv">Regresar</a></strong></button>
				</td>
			</tr>
		</table>
	</form>
