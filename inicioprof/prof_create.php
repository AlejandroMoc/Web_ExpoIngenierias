...
if (!empty($_POST)) {
	...
	if ($valid) {
		...
		$sql = 'INSERT INTO profesor (id_profesor, nombre, apellido_paterno, apellido_materno, correo, contrasena) values(?, ?, ?, ?, ?, ?)';
		$q = $pdo->prepare($sql);
...
<head>
	...
	<link rel="stylesheet" href="css/prof_create.css">
</head>
...
<body>
		...
		<table align="center">
			<tr>
				<td align="center" style="width: 33.33%;">
					<h1><strong>Registrar Profesor</strong></h1>
				</td>
				<td align="center" style="width: 33.33%;" class="logo"> <img
						src="../src/img/logo_expo_prof.svg" style="width: 45%;"></td>
	...
	<form class="form-horizontal" action="prof_create.php" method="post" onsubmit="return verifyPassword()">
		...
		<center>
			<div align="center">
				<input type="text" id="matricula" name="matricula" required maxlength="30" placeholder="  XXXXXXXXX"
					size="70" class="input" value="<?php echo !empty($matricula) ? $matricula : ''; ?>">
